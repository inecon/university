...
public class Initialization {
    ...
    Set<Student> VALID_STUDENT_SET = new TreeSet<>();
    Set<Teacher> VALID_TEACHERS_SET = new TreeSet<>();
    Set<Group> VALID_GROUPS_SET = new TreeSet<>();
    Set<Lecture> VALID_LECTURES_SET = new TreeSet<>();
